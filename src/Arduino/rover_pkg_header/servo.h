#ifndef _ROS_rover_pkg_servo_h
#define _ROS_rover_pkg_servo_h
...
namespace rover_pkg
{
  ...
  class servo : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "rover_pkg/servo"; };
    virtual const char * getMD5() override { return "e5401181ff33a9d514daeb8a647b3152"; };
